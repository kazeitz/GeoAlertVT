package edu.vt.alerts.android.library.demo.AndroidGeoFence;
...
import edu.vt.alerts.android.library.demo.*;
...
/**
 * Class for connecting to GPSLocation Services and requesting geofences.
 * <b>
...
public class GeofenceRequester
    ...
    public void addGeofences(List<Geofence> geofences) throws UnsupportedOperationException {
        ...
        /*
         * Save the geofences so that they can be sent to GPSLocation Services once the
        ...
        if (!mInProgress) {
            ...
            // Request a connection to GPSLocation Services
            requestConnection();
    ...
    /**
     * Request a connection to GPSLocation Services. This call returns immediately,
    ...
    private void continueAddGeofences() {
        ...
        // Get a PendingIntent that GPSLocation Services issues when a geofence transition occurs
    ...
    /**
     * Get a location client and disconnect from GPSLocation Services
     */
    ...
    /*
     * Called by GPSLocation Services once the location client is connected.
     *
    ...
    /*
     * Called by GPSLocation Services once the location client is disconnected.
     */
    @Override
    ...
    /**
     * Get a PendingIntent to send with the request to add Geofences. GPSLocation Services issues
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        if (null != mGeofencePendingIntent) {
             ...
             * Always create a PendingIntent sent to GPSLocation Services
             * with FLAG_UPDATE_CURRENT, so that sending the PendingIntent
             * again updates the original. Otherwise, GPSLocation Services
     ...
     * connectionResult is passed in from GPSLocation Services
     */
    @Override
